...
#PARTE TESTNET:
docker run --network testnet --name bitcoin_testnet -d -v /home/vita/discoGrande:/home/bitcoin/.bitcoin --rm -p 18332:18332 -p 18433:18433 bitcoin/bitcoin -testnet=1 -txindex=1 -rpcbind=0.0.0.0 -rpcallowip=0.0.0.0/0 -zmqpubhashblock=tcp://0.0.0.0:18433 -rpcauth='testnet:70626c77b484d414f945fa9a24a42bf3$7882d3e04dd32609b99abef95e97f7ac201799c9880249ca7d68b15670319a5c';
sleep 50;
...
#PARTE MAINNET
docker run --network mainnet --name bitcoin_mainnet -d -v /home/vita/discoGrande/mainnet:/home/bitcoin/.bitcoin --rm -p 8332:8332 -p 8433:8433 bitcoin/bitcoin -txindex=1 -rpcbind=0.0.0.0 -rpcallowip=0.0.0.0/0 -zmqpubhashblock=tcp://0.0.0.0:8433 -rpcauth='mainnet:7093e4071b32228d44db26132978368b$16257d20a01a71e5ea19d2f5174524d28be1c08959fb100c86f92f7eacd768f5';
